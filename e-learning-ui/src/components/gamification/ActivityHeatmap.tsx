...
const COLOR_LEVELS = [
  'bg-muted dark:bg-neutral-800', // Level 0: No activity
  'bg-emerald-200 dark:bg-emerald-900', // Level 1: Low
  'bg-emerald-400 dark:bg-emerald-700', // Level 2: Medium-low
  'bg-emerald-500 dark:bg-emerald-500', // Level 3: Medium
  'bg-emerald-600 dark:bg-emerald-400', // Level 4: High
];
                        ...
                        <TooltipTrigger asChild>
                          <div
                            className={cn(
                              ...
                              !day.isFuture && 'hover:ring-1 hover:ring-muted-foreground/30'
                            )}
                          />
                        </TooltipTrigger>
                        {!day.isFuture && (
                          <TooltipContent
                            side="top"
                            className="bg-popover text-popover-foreground px-3 py-2 shadow-xl"
                          >
