...
const Index = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-zinc-950 text-zinc-50 font-sans selection:bg-orange-500/30">
      ...
      <motion.div
        ...
        className="absolute inset-0 z-0 bg-[length:200%_200%] opacity-40 bg-gradient-to-br from-indigo-950 via-zinc-950 to-orange-950/30"
      />

      {/* Grain overlay */}
      <div className="pointer-events-none absolute inset-0 z-0 opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] brightness-100 contrast-150" />
      ...
      >
        ...
        <SwiperSlide className="flex items-center justify-center bg-zinc-950 px-4">
          <div className="mx-auto max-w-7xl w-full">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-zinc-400">Everything you need to master your learning journey.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 h-auto md:h-[460px]">
              
              {/* Feature 1: Progress (Large Left) */}
              <SpotlightCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between group overflow-hidden relative p-6">
                {/* Background Pattern */}
                ...
                <div className="relative z-10 max-w-[80%]">
                  <h3 className="text-xl font-medium text-zinc-100">Structured Learning Paths</h3>
                ...
                {/* Animated UI Mockup */}
                <div className="mt-4 relative h-60 w-full overflow-hidden rounded-xl border border-white/5 bg-zinc-950/50 p-4 shadow-inner flex items-end">
              ...
              <SpotlightCard className="group relative overflow-hidden p-6 hover:!bg-zinc-900/90 transition-colors duration-500">
                ...
                <div className="absolute top-[-10px] right-[-10px] z-20 opacity-90 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
                   <motion.img 
                     animate={{ y: [0, -8, 0], rotate: [0, 5, 0] }}
                     transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
                     src="/3d-icons/trophy.png" 
                     alt="Trophy 3D" 
                     className="w-28 h-28 object-contain drop-shadow-[0_15px_30px_rgba(249,115,22,0.4)]" 
                   />
                </div>

                <div className="relative z-10 flex flex-col h-full justify-end pb-2">
                  <h3 className="text-lg font-medium text-zinc-100">Earn XP & Badges</h3>
                  <p className="mt-2 text-xs text-zinc-400 leading-relaxed z-10 relative mb-14 max-w-[90%]">
              ...
              <SpotlightCard className="group relative overflow-hidden p-6 hover:!bg-zinc-900/90 transition-colors duration-500">
                ...
                <div className="absolute top-0 right-0 z-20 opacity-90 transition-transform duration-500 group-hover:scale-105">
                   <motion.img 
                     animate={{ y: [0, -5, 0] }}
                     transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                     src="/3d-icons/shield.png" 
                     alt="Shield 3D" 
                     className="w-24 h-24 object-contain drop-shadow-[0_10px_20px_rgba(168,85,247,0.3)]" 
                   />
                </div>

                <div className="relative z-10 flex flex-col h-full justify-end pb-2">
                  <h3 className="text-lg font-medium text-zinc-100">Verifiable Credentials</h3>
                  <p className="mt-2 text-xs text-zinc-400 leading-relaxed z-10 relative mb-12 max-w-[90%]">
        ...
        {/* --- SLIDE 3: FOR STUDENTS & TEACHERS (REPLACED TECH STACK) --- */}
        <SwiperSlide className="flex items-center justify-center bg-zinc-950 px-4">
          <div className="mx-auto max-w-6xl w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <GlassCard className="flex flex-col h-full bg-gradient-to-b from-white/5 to-transparent" delay={0.1} borderLight={true}>
                ...
                <ul className="space-y-4 text-zinc-400 flex-1">
              ...
              <GlassCard className="flex flex-col h-full bg-gradient-to-b from-white/5 to-transparent border-orange-500/20" delay={0.2} borderLight={true}>
                <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-orange-500/10 text-orange-400">
                  <PenTool size={28} />
                </div>
                <h3 className="text-2xl font-medium mb-4 text-white">For Teachers</h3>
                <ul className="space-y-4 text-zinc-400 flex-1">
                  <li className="flex gap-3">
              ...
              <GlassCard className="flex flex-col h-full bg-gradient-to-b from-white/5 to-transparent" delay={0.3} borderLight={true}>
                <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-green-500/10 text-green-400">
                  <Lock size={28} />
                </div>
                <h3 className="text-2xl font-medium mb-4">Trust & Safety</h3>
                <ul className="space-y-4 text-zinc-400 flex-1">
                  <li className="flex gap-3">
